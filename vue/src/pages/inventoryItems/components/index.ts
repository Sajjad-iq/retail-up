...
export { default as InventorySelector } from './InventorySelector.vue'
...
export { default as InventoryItemsNoSelectionState } from './InventoryItemsNoSelectionState.vue'
