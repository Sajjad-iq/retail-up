 ...
 * endpoints. All operations are scoped to the current authenticated user.
 * 
 * @author Sajjad Kadem
 * @version 1.0
 * @since 2024-12-19
...
@Tag(name = "Authentication", description = "Authentication and authorization endpoints (user-scoped)")
public class AuthController {
         ...
         */
        @Operation(summary = "Get Current User Profile", description = "Retrieve the current authenticated user's profile information", operationId = "getCurrentUserProfile", security = @SecurityRequirement(name = "Bearer Authentication"))
        @ApiResponse(responseCode = "200", description = "User profile retrieved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = User.class), examples = @ExampleObject(name = "User Profile", value = """
                        {
                            "id": "user123",
                            "name": "John Doe",
        ...
        public ResponseEntity<User> getCurrentUserProfile() {
                User userProfile = userService.getCurrentUserProfile();
         ...
         */
        @Operation(summary = "Change Current User Password", description = "Change the current authenticated user's password with old password verification", operationId = "changePassword", security = @SecurityRequirement(name = "Bearer Authentication"))
        @ApiResponses(value = {
