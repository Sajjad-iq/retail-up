    ...
    private void initializePermissions() {
        ...
        List<PermissionData> permissionsData = Arrays.asList(
                ...
                new PermissionData("pos.sell", "POS Sell", "Create sales transactions",
                        Permission.PermissionCategory.POS, false),
                new PermissionData("pos.refund", "POS Refund", "Process refunds", Permission.PermissionCategory.POS,
                        false),
                ...
                new PermissionData("inventory.view", "View Inventory", "View inventory items and stock levels",
                        Permission.PermissionCategory.INVENTORY, false),
                new PermissionData("inventory.manage", "Manage Inventory", "Add, edit, and remove inventory items",
                        Permission.PermissionCategory.INVENTORY, false),
                new PermissionData("inventory.adjust", "Adjust Stock", "Adjust inventory stock levels",
                        Permission.PermissionCategory.INVENTORY, false),
                new PermissionData("inventory.movements", "View Stock Movements", "View stock movement history",
                        Permission.PermissionCategory.INVENTORY, false),
                new PermissionData("inventory.alerts", "Inventory Alerts", "Manage low stock and expiry alerts",
                        Permission.PermissionCategory.INVENTORY, false),

                // Users Permissions
                new PermissionData("users.view", "View Users", "View user accounts and information",
                        Permission.PermissionCategory.USERS, false),
                new PermissionData("users.manage", "Manage Users", "Create, edit, and delete user accounts",
                        Permission.PermissionCategory.USERS, false),
                new PermissionData("users.permissions", "Manage User Permissions", "Assign and revoke user permissions",
                        Permission.PermissionCategory.USERS, false),
                new PermissionData("users.activities", "View User Activities", "View user activity logs",
                        Permission.PermissionCategory.USERS, false),
                ...
                new PermissionData("settings.business", "Business Settings", "Manage business configuration",
                        Permission.PermissionCategory.SETTINGS, false),
                new PermissionData("settings.pos", "POS Settings", "Configure POS system settings",
                        Permission.PermissionCategory.SETTINGS, false),
                new PermissionData("settings.inventory", "Inventory Settings", "Configure inventory settings",
                        Permission.PermissionCategory.SETTINGS, false),
                new PermissionData("settings.payments", "Payment Settings", "Configure payment methods",
                        Permission.PermissionCategory.SETTINGS, false),
                new PermissionData("settings.notifications", "Notification Settings", "Manage notification preferences",
                        Permission.PermissionCategory.SETTINGS, false),
                new PermissionData("settings.integrations", "Integration Settings", "Manage third-party integrations",
                        Permission.PermissionCategory.SETTINGS, false),

                // Admin Permissions
                new PermissionData("admin.full_access", "Full Admin Access", "Complete system administration access",
                        Permission.PermissionCategory.ADMIN, true),
                new PermissionData("admin.system", "System Administration", "System-level administrative functions",
                        Permission.PermissionCategory.ADMIN, true),
                new PermissionData("admin.backup", "Backup & Restore", "Database backup and restore operations",
                        Permission.PermissionCategory.ADMIN, true),
    ...
    private void initializeAdminUser() {
        ...
        if (!userRepository.existsByEmail(adminEmail)) {
            ...
            User adminUser = User.builder()
                    ...
                    .email(adminEmail)
                    .password(passwordEncoder.encode("admin123")) // Default password - should be changed on first login
                    .phone("+1234567890")
                    .department("IT")
                    .employeeId("ADMIN001")
