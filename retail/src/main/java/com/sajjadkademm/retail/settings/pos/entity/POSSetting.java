package com.sajjadkademm.retail.settings.pos.entity;
...
@Table(name = "pos_settings", indexes = {
        ...
        @Index(name = "idx_pos_settings_key", columnList = "key_name"),
        @Index(name = "idx_pos_settings_organization_key", columnList = "organization_id,key_name")
})
